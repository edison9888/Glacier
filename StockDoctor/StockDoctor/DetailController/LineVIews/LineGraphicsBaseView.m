...
#define data_start (1.5/20.0f)
#define data_end (12.0f/20.0f)
#define buttom_string_start (12.0/20.0f)
#define buttom_string_end (13.0f/20.0f)
#define volume_start (14.5f/20.0f)
#define volume_end (19.5f/20.0f)
