...
@property (nonatomic,assign) float PD_SELF;
@property (nonatomic,assign) float PD_COUPLE;
@property (nonatomic,assign) float PD_CHILD;
@property (nonatomic,assign) float PD_OWNER;
@property (nonatomic,copy) NSString * PD_FEETYPE;
@property (nonatomic,copy) NSString * PD_PREMCATEGORY;
@property (nonatomic,assign) float PD_HIGHPREM;
@property (nonatomic,assign) float PY_FULLYEAR;
@property (nonatomic,assign) float PD_ONEPAY;
...
@property (nonatomic,assign) float PD_MODELIMIT;
@property (nonatomic,copy) NSString * PD_PDTCONT;
@property (nonatomic,copy) NSString * PD_PDTCONT1;
@property (nonatomic,assign) float PD_VERSIONNO;
